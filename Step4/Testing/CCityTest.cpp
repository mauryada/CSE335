	...
	public:
		...
		*/
		...
		TEST_METHOD(TestCCityVisitor)
		{
			...
			Assert::AreEqual(1, visitor.mNumCoalmines, L"Visitor number of coalmine");
			...
			Assert::AreEqual(0, emptyVisitor.mNumRoads, L"Visitor number of roads");
			Assert::AreEqual(0, emptyVisitor.mNumLandscapes, L"Visitor number of landscapes");
			Assert::AreEqual(0, emptyVisitor.mNumCoalmines, L"Visitor number of coalmine");
			Assert::AreEqual(0, emptyVisitor.mNumBuildings, L"Visitor number of buildings");
