...
*
* Class the implements the Fish2
*/
...
/// Fish filename 
const wstring FishBetaImageName(L"images/nemo.png");

/**
* Constructor
*/
CFish2::CFish2(CAquarium *aquarium) : CItem(aquarium)
{
...
* \return true if hit.
*/
bool CFish2::HitTest(int x, int y)
{
