...
*/
std::shared_ptr<CActor> CAlienFactory::Create()
{
	shared_ptr<CActor> actor = make_shared<CActor>(L"Alien1");
	...
	auto vest = make_shared<CImageDrawable>(L"Vest", L"images/black_coat.png");
	...
	lhand->SetColor(Color(0, 218, 180));
	...
	rhand->SetColor(Color(0, 218, 180));
